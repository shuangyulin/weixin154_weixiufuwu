<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="维修单号" prop="weixiudanhao">
            <el-input v-model="ruleForm.weixiudanhao" 
                placeholder="维修单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.weixiudanhao" label="维修单号" prop="weixiudanhao">
              <el-input v-model="ruleForm.weixiudanhao" 
                placeholder="维修单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="保修期" prop="baoxiuqi">
          <el-input v-model="ruleForm.baoxiuqi" 
              placeholder="保修期" clearable  :readonly="ro.baoxiuqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保修期" prop="baoxiuqi">
              <el-input v-model="ruleForm.baoxiuqi" 
                placeholder="保修期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="维修状态" prop="weixiuzhuangtai">
          <el-select v-model="ruleForm.weixiuzhuangtai" placeholder="请选择维修状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="维修状态" prop="weixiuzhuangtai">
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.weixiuzhuangtaiOptions = "未维修,维修中,已维修".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
