<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配置" prop="peizhi">
          <el-input v-model="ruleForm.peizhi" 
              placeholder="配置" clearable  :readonly="ro.peizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配置" prop="peizhi">
              <el-input v-model="ruleForm.peizhi" 
