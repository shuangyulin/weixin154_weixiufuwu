      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="维修单号" prop="weixiudanhao">
          <el-input v-model="ruleForm.weixiudanhao" 
              placeholder="维修单号" clearable  :readonly="ro.weixiudanhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维修单号" prop="weixiudanhao">
              <el-input v-model="ruleForm.weixiudanhao" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.pingjianeirong = this.ruleForm.pingjianeirong.replace(reg,'../../../ssmo5ar1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
