    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="配件介绍" prop="peijianjieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="配件介绍"
                  v-model="ruleForm.peijianjieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peijianjieshao" label="配件介绍" prop="peijianjieshao">
                    <span>{{ruleForm.peijianjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="配件详情" prop="peijianxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.peijianxiangqing" label="配件详情" prop="peijianxiangqing">
                    <span v-html="ruleForm.peijianxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiage = true;
          ...
          if(o=='peijianjieshao'){
            this.ruleForm.peijianjieshao = obj[o];
	    this.ro.peijianjieshao = true;
            continue;
          }
	...
	this.ruleForm.peijianxiangqing = this.ruleForm.peijianxiangqing.replace(reg,'../../../ssmo5ar1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
